...
public class UnicastDemand extends Demand {
	...
	public String toString() {
		...
		return "{\"UnicastDemand\": " +"{\"source\": " +"{"+ "\"name\":" + "\"" +source.getName() +"\""+", " +"\"xcoordinate\": " + source.getPosition().getX()+ "," +"\"ycoordinate\": " +source.getPosition().getY()+ "}, " + "\"destination\": " + "{"+ "\"name\":" + "\"" +destination.getName() +"\""+ ", " + "\"xcoordinate\": " + destination.getPosition().getX()+ ", 	" + "\"ycoordinate\": " + destination.getPosition().getY()+ "	}," + "\"volume\": " + getVolume() + ", \"" + "ttl\": " + getTTL() + ", \"initialttl\": " + getInitialTTL() + "}}";
	}
}

...
public abstract class AnycastDemand extends Demand {
	...
	public String toString() {
		return "{\"AnycastDemand\": {\"client\": {"+ "\"name\":" + "\"" +client.getName() +"\""+ ", \"xcoordinate\": " + client.getPosition().getX()+ ", \"ycoordinate\": " + client.getPosition().getY()+ "}, \"volume\": " + getVolume() + ", \"ttl\": " + getTTL() + ", \"initialttl\": " + getInitialTTL() + "}}";
	}
}